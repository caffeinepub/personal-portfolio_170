  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        className: "w-12 h-12",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "32", cy: "14", r: "8", stroke: "currentColor", strokeWidth: "2.5" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
    ...
    icon: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M10 32h44", stroke: "currentColor", strokeWidth: "2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "path",
            {
...
const PROJECTS = [
  {
    ...
    description: "An AI-powered weather assistant chatbot that provides real-time weather updates, forecasts, and conversational weather insights through a clean, interactive interface.",
  ...
  },
  {
    ...
    description: "A modern UI/UX design portfolio demo featuring smooth fade and loop animations, sleek dark interface design, and glowing neon accents showcasing advanced web animation techniques.",
...
function StatCard({
  ...
  const display = value < 10 ? String(count).padStart(2, "0") : count.toLocaleString();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-4 p-8 border-r last:border-r-0 border-[#1F2937]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: "#94A3B8" }, children: icon }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm", style: { color: "#64748B" }, children: label })
    ] })
  ] });
}
function Stats() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4", children: STATS.map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { ...stat, animate }, stat.label)) }) })
    }
  );
}
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-[#111827]/95 backdrop-blur-md shadow-lg" : "bg-transparent"} border-b border-[#1F2937]`,
      children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 w-full pt-20 pb-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "animate-fade-in-up-delay text-5xl sm:text-6xl lg:text-7xl font-extrabold leading-tight text-white mb-4", children: [
              "Raparthi",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "#94A3B8" },
                children: "Web Developer | Java & Python Developer"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                style: { color: "#94A3B8" },
                children: "Passionate about building efficient software solutions and uncovering insights through data. Skilled in Java, Python, C, MySQL, and Data Analytics."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "animate-fade-in-up-delay3 flex flex-wrap gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex items-center justify-center relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-[#94A3B8] tracking-widest uppercase", children: "Scroll" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-gradient-to-b from-[#94A3B8] to-transparent" })
        ] })
      ]
    }
  );
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      style: { background: "#0f172a" },
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-16 items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6 mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "linear-gradient(135deg, #0ea5e9, #6366f1)",
                    boxShadow: "0 0 30px rgba(14,165,233,0.4), 0 0 60px rgba(99,102,241,0.2)"
                  },
                  children: "RK"
                }
              ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 16, style: { color: "#0ea5e9" } }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-white", children: "Who I Am" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              style: { color: "#94A3B8" },
              children: "Hi! I'm Raparthi Karthik, a developer passionate about creating efficient and impactful software. I specialize in Java, Python, and C programming, backed by strong skills in MySQL database management and Data Analytics."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              style: { color: "#94A3B8" },
              children: "I love turning complex data into actionable insights and building robust backend systems. Always eager to learn new technologies and take on challenging projects."
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { size: 16, style: { color: "#6366f1" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "text-sm font-semibold uppercase tracking-wider",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-white mb-6", children: "What I Work With" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: SKILLS.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
...
function Projects() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      className: "py-24 px-4 sm:px-6",
      style: {
        background: "linear-gradient(180deg, #0f172a 0%, #0c1a3d 50%, #0f172a 100%)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { size: 16, style: { color: "#0ea5e9" } }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "text-sm font-semibold uppercase tracking-wider",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl font-bold text-white mb-4", children: "My Projects" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: PROJECTS.map((project) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white mb-2", children: project.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "p",
                  {
...
Sent from portfolio contact form`
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "contact", style: { background: "#eeeeee" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 680, margin: "0 auto", padding: "80px 24px 0" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "h2",
        {
          style: {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#aaa" }, children: "Say Hi!" }),
            " and tell me about",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { color: "#888", marginBottom: 40, fontSize: 15 }, children: "Have a nice works? reach out and let's chat." }),
      submitted ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          style: { padding: "40px 0", textAlign: "center", color: "#111" },
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 20, fontWeight: 700 }, children: "Thanks! I'll get back to you within 24 hours." })
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, "data-ocid": "contact.modal", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "label",
                  {
                    ...
                    children: [
                      "Name.",
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#e00" }, children: "*" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: 28 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: 8 }, children: tags.map((tag) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              style: {
                ...
                background: selected.includes(tag) ? "#111" : "transparent",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 12, color: "#999" }, children: "I'll must get back to you within 24 hours" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "submit",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 24, fontSize: 13, color: "#555" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: 12, color: "#999" }, children: "Personal Portfolio©2024" })
        ]
      }
    )
  ] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", style: { color: "#94A3B8" }, children: [
          "© ",
          year,
          " Raparthi Karthik. Built with ❤️ using",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "a",
            {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", style: { background: "#0f172a" }, children: [
